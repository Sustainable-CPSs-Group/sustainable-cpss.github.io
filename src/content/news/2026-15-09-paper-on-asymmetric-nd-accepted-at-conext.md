Our paper on optimal asymmetric ND has been accepted to the ACM International Conference on emerging Networking EXperiments and Technologies (CoNEXT).
-----------------------------------------------------------------------------------------------------------------------------------------------------
...
Schedules of transmissions and reception windows designed for this purpose that provide the theoretically best relation between energy consumption and latency are known when the energy budget on both sides is fixed.
...
an optimal protocol with fixed duty-cycles. We also present *Ahoi*, a protocols that provides a provably optimal performance while allowing every device to choose among different duty-cycles and hence, power budgets.
